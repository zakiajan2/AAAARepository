...
public class Class1 {
	public static void main(String[] args) {
		 ...
		 * -save the url you need in eclips in eclips after creating a project you need
...
System.out.println("to creat new branch go toproject team- switch- put name- config-merge" +"or repository switch");
...
String moveToMain="to move changes to main repo in git hub we have to go to github account and make pull Request there";
	String remember="at job it is better first pull to see changes in main then push your code to main";
<<<<<<< HEAD
	//new change
=======
	//to create new branch SDWTB : project-team-switch-SDETB
>>>>>>> master
	}
}
